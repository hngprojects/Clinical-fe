    ...
    <section className="bg-[#FAFAFA] py-16 lg:py-24">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="mb-12 lg:mb-16 grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col gap-6 items-start lg:justify-end">
            ...
            <div className="flex flex-wrap items-center justify-start gap-4 lg:ml-auto lg:w-full lg:max-w-md lg:justify-start">
              {/* App Store Button */}
