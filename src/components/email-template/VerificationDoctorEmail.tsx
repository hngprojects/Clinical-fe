interface VerificationDoctorEmailProps {
  pin: string;
  expirationTime: string;
}

export const VerificationDoctorEmail = ({ pin, expirationTime }: VerificationDoctorEmailProps) => {
  return (
    <div className="font-sans leading-relaxed text-gray-800">
      <div className="max-w-2xl mx-auto p-5">
        ...
        {/* PIN Code */}
        <div className="bg-gray-100 border-2 border-green-500 p-5 rounded-lg mb-5 text-center">
          <p className="text-sm text-gray-600 m-0 mb-3">Verification Code</p>
          <p className="text-4xl font-bold tracking-widest m-0 text-green-500">
            {pin}
          </p>
        </div>
